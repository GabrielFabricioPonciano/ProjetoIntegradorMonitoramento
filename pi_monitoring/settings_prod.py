# pi_monitoring/settings_prod.py
"""
Configurações de produção para o Projeto Integrador IV.
...
DATABASES = {
    'default': {
        ...
        'NAME': config('DB_NAME', default='pi_monitoring'),
        'USER': config('DB_USER', default='pi_user'),
...
SPECTACULAR_SETTINGS = {
    'TITLE': 'PI IV - Monitoramento de Temperatura e Umidade',
    'DESCRIPTION': 'Sistema Inteligente de Monitoramento Ambiental - APIs REST',
    'VERSION': '1.0.0',
...
# Prometheus Configuration (opcional)
if config('ENABLE_PROMETHEUS', default=False, cast=bool):
    INSTALLED_APPS.append('django_prometheus')
    MIDDLEWARE.insert(0, 'django_prometheus.middleware.PrometheusBeforeMiddleware')
    MIDDLEWARE.append('django_prometheus.middleware.PrometheusAfterMiddleware')

# Simulador Configuration (desabilitado em produção)
ENABLE_SIM_JOB = False
SIM_JOB_INTERVAL_SECONDS = 3600  # 1 hora em produção